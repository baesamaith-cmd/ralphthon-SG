...
- No speculative features outside the current ticket.
- No broad architecture rewrite unless a ticket requires a state-format migration.
- No hidden state outside documented files and environment variables.
